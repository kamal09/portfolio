                ...
                <div className="row">
                    ...
                    <div className="col-9">
                        <div className="d-flex flex-column">
                            <div className="py-2 " style={{background: "#418ab3"}}><div className="mx-3">MD. KAMAL HOSSAIN</div></div>
                        </div>
                ...
                <div className="row">
                    ...
                    <div className="col-9">
                        ...
                        <div>
                            ...
                            <div className="my-1" style={{color: "#418ab3"}}>Newgen Technology Limited,
                                Dhaka(Bangladesh). web:
                                <a href="https://newgen-bd.com/" className="link-primary">https://newgen-bd.com/</a>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="my-1" style={{color: "#418ab3"}}>Datasoft Systems Bangladesh Limited,
                                Dhaka(Bangladesh). web:
                                <a href="https://datasoft-bd.com/" className="link-primary">https://datasoft-bd.com/</a>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="my-1" style={{color: "#418ab3"}}>Human Resocia, Shinjuku (Japan). web:
                                <a href="https://git.resocia.jp/en/"
                                   className="link-primary">https://git.resocia.jp/en/</a>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="my-1" style={{color: "#418ab3"}}>BRAC IT Services Limited, Dhaka
                                (Bangladesh). web:
                                <a href="http://www.bracits.com/" className="link-primary">http://www.bracits.com/</a>
                            </div>
                            <div className="px-2">
                        ...
                        <div>
                            ...
                            <div className="my-1" style={{color: "#418ab3"}}>R-Creation, Chittagong (Bangladesh). web:
                                <a href="http://rcreation-bd.com/" className="link-primary">http://rcreation-bd.com/</a>
                            </div>
                            <div className="px-2">
